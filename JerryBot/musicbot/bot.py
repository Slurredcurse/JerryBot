...
class MusicBot(discord.Client):
    ...
    async def cmd_help(self, command=None):
        ...
        if command:
            ...
            helpmsg += "```"
            helpmsg += "https://github.com/OhJeriel/JerryBot/wiki/Commands"
    ...
    async def cmd_fiji(self, channel):
        return Response("**I heard ya like AeStHeTiC wAtEr** https://www.youtube.com/watch?v=g2iBDUNRNqE")
		
    async def cmd_whosdaddy(self, channel):
        return Response("**Jerry is** :relaxed: :yum: :heart_eyes: :raised_hands::skin-tone-2:")


if __name__ == "__main__":
    bot = JerryBot()
    bot.run("MzM0MTg2NjE3Mjk4MjIzMTE1.DIHn3w.fzD53tsA0s9AYlWR2hn_ijrYkRM")
